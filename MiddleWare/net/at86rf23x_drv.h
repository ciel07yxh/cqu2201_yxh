...
**
*********************************************************************************************************/
#ifndef  __AT86RF231_DRV_H__
#define  __AT86RF231_DRV_H__
...
#define RF_RSTN_PIN                     GPIO_PIN_5
// RF_SPI SEL硬件连接
#define RF_SPI_SEL_BASE                 GPIOB_BASE
#define RF_SPI_SEL_PIN                  GPIO_PIN_1
// RF SLP_TR硬件连接
#define RF_SLP_TR_BASE                  GPIOC_BASE
#define RF_SLP_TR_PIN                   GPIO_PIN_4
// RF IRQ硬件连接
...
/*********************************************************************************************************
  硬件延时参数定义，需要参看详细的硬件手册，这里是AT86RF231的延时参数
*********************************************************************************************************/
#define TIME_TO_ENTER_P_ON              330 /**<  Transition time from VCC is applied to P_ON - most favorable case! */
#define TIME_SLEEP_TO_TRX_OFF           380 /**<  Transition time from SLEEP to TRX_OFF. */
#define TIME_TRX_OFF_TO_SLEEP           35  /**<  35*1/fCLKM. This need fCLKM > 250 kHz. */
#define TIME_TRX_OFF_TO_PLL_ON          110 /**<  Transition time from TRX_OFF to PLL ON. */
#define TIME_PLL_ON_TO_TRX_OFF          1   /**<  Transition time from PLL_ON to TRX_OFF. */
#define TIME_TRX_OFF_TO_RX_ON           110 /**<  Transition time from TRX_OFF to RX_ON. */
...
#define TIME_PLL_ON_TO_BUSY_TX          16  /**<  Transition time from PLL_ON to BUSY_TX. */
...
#define TIME_RESET_TO_TRX_OFF           37  /**<  Transition time from RESET to TRX_OFF. */
